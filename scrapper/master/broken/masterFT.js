...
//////////////////////////
	function getURLft()
	{
	  ...
	  request({
		...
		$("body a").each(function(i) {
		  ...
		  {*/
          if( myhref !== undefined){
		  if (myhref.substring(11,17) === "ft.com" && oldhref !== myhref)
		  {
			oldhref = myhref;
			//myhref = "http://www.ft.com"+myhref;
			tarray.push(myhref);
			//console.log(myfile);
			//console.log(myhref);
			i++;
	...
	function getArticleft(array){
	  ...
	  while (j<array.length-1)
	  {
        ...
        //console.log(tmyfile);
		fd = fs.openSync("Articles/FT/FT_"+tmyfile, "w");
		fs.closeSync(fd);
        ...
        //console.log(myfile);
        console.log(array[k]);
		fs.appendFile("Articles/FT/FT_"+myfile, array[k]+"\n", function (err) {});
		  ...
		  $("#main div div div div div div div div div img").each(function(element) {
			...
			//console.log(text);
			fs.appendFile("Articles/FT/FT_"+myfile, text, function (err) {});
		  });
